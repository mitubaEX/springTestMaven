...
public class Extractor{
	public void extractBirthmark(String fileOriginalName) throws IOException, ScriptException{
	...
	public void createExtractFile(MultipartFile file) throws IOException,ScriptException{
